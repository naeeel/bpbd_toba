...
class _MitigasiScreenState extends State<MitigasiScreen>
  ...
  void addAllListData() {
    ...
    Padding(
      ...
      child: Card(
        elevation: 5, // Menambah bayangan di bawah card
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.0), // Membuat cekungan di setiap sisinya
        ),
        child: Theme(
          data: ThemeData(
                  ...
                  Container(
                   // Mengatur warna latar belakang menjadi putih
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10.0), // Melengkungkan sudut gambar
                    ),
                  ),
                  Expanded(
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Gempa Bumi',
                          style: TextStyle(
                            color: Color.fromARGB(255, 238, 142, 53),
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            fontFamily: 'Roboto', // Mengatur font menjadi Roboto
                          ),
                        ),
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Banjir',
                          style: TextStyle(
                            color: Color.fromARGB(255, 52, 120, 247),
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            fontFamily: 'Roboto', // Mengatur font menjadi Roboto
                          ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Longsor',
                          style: TextStyle(
                            color: Color.fromARGB(255, 105, 61, 36),
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            fontFamily: 'Roboto', // Mengatur font menjadi Roboto
                          ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Gunung Erupsi',
                          style: TextStyle(
                            color: Color.fromARGB(255, 185, 77, 58),
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            fontFamily: 'Roboto', // Mengatur font menjadi Roboto
                          ),
